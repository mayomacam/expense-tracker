        ...
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-2.5">
            ...
            <button
              ...
              className="px-2.5 py-1.5 text-xs font-semibold text-black bg-[#c1ff72] hover:bg-[#b0f05f] rounded-xl shadow-[0_0_10px_rgba(193,255,114,0.3)] transition-all flex items-center gap-1.5 font-mono"
              title="Open Sidebar Overview & Budget Gauges"
            >
              <PieChart className="w-3.5 h-3.5 text-black" />
